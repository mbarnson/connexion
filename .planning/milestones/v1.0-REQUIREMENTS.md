# Requirements Archive: v1.0 OpenAPI 3.1 Support
...
- [x] **TEST-04**: Comprehensive test suite covers every 3.1 feature
...
- Python 3.9/3.10 support -- we require 3.11+
...
**Adjusted:** VALID-04 changed from "backwards-compatible nullable handling" to "strict nullable rejection" (user decision during Phase 2)
**Dropped:** None
